...
namespace ZBrad.FabLibs.Wcf.Gateway
{
    ...
    /// and PartitionKey
    /// </summary>
    internal class Filter : MessageFilter
    {
        ...
        public Filter(WcfService service, Uri uri, F.ResolvedServicePartition rsp)
        {
        ...
        ServiceEndpoint getServiceEndpoint(Uri u)
        {
            ...
            var e = new ServiceEndpoint(this.Service.Contract, b, a);
            return e;
        }
