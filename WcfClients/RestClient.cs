...
namespace ZBrad.ServiceFabric.Wcf
{
    public class RestClient<T> where T : class, new()
    {
        ...
        private RestClient(string path, Partition partition)
        {
            this.path = path;
        ...
        private RestClient(string path, Partition partition, string viaPath) : this(path, partition)
        {
        ...
        public static bool TryCreate(string path, Partition partition, out RestClient<T> cw)
        {
            cw = null;
            try
            {
        ...
        /// <param name="cw">the new instance</param>
        /// <returns>true if successful</returns>
        public static bool TryCreate(string path, Partition partition, string viaPath, out RestClient<T> cw)
        {
            cw = null;
            try
            {
